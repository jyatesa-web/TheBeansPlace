...
const values = [
    ...
    },
    {
        ...
        title: "Small-Batch Roasting",
        description:
            "Our master roaster profiles every bean to unlock its peak flavor. We roast in 25lb for consistency and freshness you can taste."
    },
    {
        icon: "🚚",
        title: "Roast-to-Order Shipping",
        description:
            "We don't pre-roast and shelve. Your beans are roasted after you order and shipped within 1-2 days. Free delivery on orders over $50."
    }
];
        ...
        <div className="about-content">
            <ScrollReveal animation="fadeUp">
                <Badge variant="default" className="mb-4">
                    Founded 2012 | Roasting in-housing sonce day 1
                </Badge>
            </ScrollReveal>
